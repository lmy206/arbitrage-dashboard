...
- 用户已批准本项目使用以下外部补充源：新浪 LME 铜/铝/锌三个月电子盘、马来西亚 FCPO、CBOT 美豆油与美豆粕期货，国家外汇管理局美元兑人民币和人民币兑林吉特中间价、BNM 最新人民币兑林吉特校对值、中证指数有限公司沪深300滚动市盈率、中国债券信息网中国10年期国债收益率、东方财富美国10年期国债收益率、新浪纳斯达克综合指数与标普500指数、Multpl 标普500月度市盈率。
...
3. 只有在 `status=ok`、`pairCount=expectedPairCount=35`、`futureDataDetected=false`、`hierarchySorted=true` 且 `externalSourcesComplete=true` 时，才运行：
