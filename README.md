...
国内行情以 `xtdata` 为唯一主源；外部补充包括 LME/FCPO、CBOT 美豆油与美豆粕、新浪美股指数、中证指数估值、中美10年期国债收益率、Multpl 标普500市盈率、外管局汇率和纽约联储 SOFR/OBFR，均写入共享目录并接受完整性校验。
...
- 美元资金压力：`（SOFR−OBFR）×100`，单位为基点。SOFR 是美债回购融资利率，OBFR 除联邦基金交易外还含部分 Eurodollar 与离岸分支美元借款；利差上冲表示回购融资相对广义无担保美元融资变贵。它固定排在第三位，只是资金压力确认项，不能替代交叉货币基差、信用利差和市场深度组成的完整离岸美元监测。
- 海外相对指标：纳斯达克/标普500使用两只现货指数收盘价；马盘棕榈油/美盘豆油保持 `FCPO（林吉特/吨）`，将 `CBOT美豆油（美分/磅）` 换算为美元/公吨后，再用马币/美元交叉汇率换成马币/公吨相除；马币/美元按“人民币/美元 ÷ 人民币/马币”由外管局中间价交叉推导，并以 BNM 最新值校对，不再把两条腿折成人民币；美盘油粕比=`CBOT美豆油（美分/磅）×20÷CBOT美豆粕（美元/短吨）`，先把两腿统一为美元/短吨再计算。
