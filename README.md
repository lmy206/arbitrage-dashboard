...
国内行情以 `xtdata` 为唯一主源；外部补充包括 LME/FCPO、CBOT 美豆油与美豆粕、新浪美股指数、中证指数估值、中美10年期国债收益率、Multpl 标普500市盈率、外管局汇率、纽约联储 OBFR 和美联储理事会 IORB，均写入共享目录并接受完整性校验。
...
- 美元银行融资压力代理：`（OBFR−IORB）×100`，单位为基点。OBFR 是纽约联储公布的广义无担保隔夜银行融资利率，IORB 是美联储理事会设定并付给合格机构准备金余额的管理利率；利差上冲表示银行批发无担保融资相对准备金余额管理利率变贵。它固定排在第三位，IORB 官方日度序列自 2021-07-29 起，只是银行融资压力代理，不能替代交叉货币基差、信用利差和市场深度组成的完整离岸美元监测。
